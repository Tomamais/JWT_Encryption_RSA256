...
namespace MyApp // Note: actual namespace depends on the project name.
{
    internal class Program
    {
        ...
        {
            string publicKey = File.ReadAllText(@$"{AppDomain.CurrentDomain.BaseDirectory}\publicKey.pem");
            string privateKey = File.ReadAllText(@$"{AppDomain.CurrentDomain.BaseDirectory}\privateKey.pem");
            ...
            Console.WriteLine($"Decoded token {payload}");
        }
